...
# --- Khởi tạo Flask ---
app = Flask(__name__)
# Dùng PostgreSQL kết nối trên Render, hoặc fallback sang SQLite khi chạy máy ảo local
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'sqlite:///travel_kit.db')
